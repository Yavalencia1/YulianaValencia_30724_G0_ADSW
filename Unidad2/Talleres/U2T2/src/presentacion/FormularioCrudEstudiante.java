...
public class FormularioCrudEstudiante extends JFrame {
    ...
    private void agregarBotones(JPanel panel, GridBagConstraints constraints, int filaBase) {
        JPanel botones = new JPanel(new GridLayout(6, 1, 0, 8));
        ...
        JButton btnCargarExterna = crearBoton("Cargar externos", new Color(123, 31, 162));
        JButton btnAuditoria = crearBoton("Ver auditoria", new Color(0, 121, 107));
        ...
        btnCargarExterna.setPreferredSize(botonSize);
        btnAuditoria.setPreferredSize(botonSize);

        btnRegistrar.addActionListener(e -> clickAgregar());
        btnActualizar.addActionListener(e -> actualizarEstudiante());
        btnEliminar.addActionListener(e -> eliminarEstudiante());
        btnMostrar.addActionListener(e -> cargarTabla());
        btnCargarExterna.addActionListener(e -> clickCargarDatos());
        ...
        botones.add(btnCargarExterna);
        botones.add(btnAuditoria);
    ...
    public void clickAgregar() {
        ...
        control.agregarEstudiante(id, texto(txtNombre), edad);
        String mensaje = control.getUltimoMensaje();
    ...
    public void clickCargarDatos() {
        control.cargarDesdeFuenteExterna();
        cargarTabla();
        mostrarMensaje(control.getUltimoMensaje(), new Color(123, 31, 162));
    }

    private void verAuditoria() {
        List<String> auditoria = control.mostrarAuditoria();
        ...
        StringJoiner contenido = new StringJoiner(System.lineSeparator());
        for (String registro : auditoria) {
            contenido.add(registro);
        }

        JTextArea area = new JTextArea(contenido.toString(), 18, 58);
